...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\gpurl on
     Windows, /home/user/dev/gpurl on Linux) in a file named
     gpurl@mozilla.messaging.inc. and copy that file to
